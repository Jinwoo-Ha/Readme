...
def generate_story(name, age, country, interests):
    ...
    prompt_template = PromptTemplate.from_template(
        ...
        총 3페이지 이내로 제작해. 
        반드시 모든 문장을 친근한 반말로 해줘야 해.
        주인공의 {age}에 맞는 수준으로 동화를 만들어줘.
        ...
        {country}에서 방문하는 도시는 최소 두 곳 이상에, 각 도시별로 세 가지 이상의 활동을 해야해.
        {country}의 각 도시에 대한 정보를 상세히 알려주고, 거기서 어떤 음식을 먹는지, 
        그 도시의 구체적인 역사, 유명한 문화, 유명한 스포츠, 필수 관광지에 대해 다양하게 언급해줘.
        도시마다 다른 내용이 들어가야해. 
        각 도시에 대한 내용은 최소 100글자가 넘도록 설명해줘.

        단, "카지노, 흡연, 음주, 도박" 등 성인들만 즐길 수 있는 활동은 표시하지 말아줘.
        동화를 끝낼때는 교훈과 소감을 다양한 문화에 대한 이해와 존중 그리고 연대감이라는 키워드를 바탕으로 {name}에게 감동을 줄 수 있는 문구로 작성해. 
